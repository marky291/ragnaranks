    ...
    _vm._l(_vm.items, function(item) {
      return _c(
        "div",
        {
          key: item.id,
          staticClass:
            "database-item hover:tw-shadow-lg hover:tw-cursor-pointer tw-flex-grow tw-shadow tw-bg-white tw-p-4 tw-flex tw-rounded tw-mb-3 tw-mx-2",
