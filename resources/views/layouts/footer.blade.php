    ...
    <footer class="">
        ...
        <div class="container d-flex mb-5">
            <div class="w-50 mr-5">
                ...
                <p>
                    Our web-service (website) is designed in a way that allows visitors to easily find the server
                    they are searching for in the box of never ending server advertisements, we accomplish this
                    by utilising tags, filters and keyword searching throughout all of our cards, this allows
                    the visitor to easily narrow down a specific search and discover servers they would never
