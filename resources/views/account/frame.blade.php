...
@section('content')
    <div class="shadow-inner">
        <div class="container py-4">
            <update-account-component inline-template :account="{{ auth()->user()->toJson() }}">
                <div class="row shadow">
                    <div class="col-3 tw-bg-grey-lightest py-4 tw-flex tw-flex-col tw-items-center">
                        <div class="avatar tw-h-32 tw-w-32 mb-4">
                            <img class="tw-rounded-full shadow tw-border tw-border-grey tw-border-2" :src="form.avatarUrl" alt="">
                        </div>
                        ...
                        <div class="navigation mt-4">
                            <ul class="list-unstyled">
                                <li {{ $selected === 'account' ? 'selected' : null }}>My Account</li>
                                <li {{ $selected === 'notifications' ? 'selected' : null }}>Notifications</li>
