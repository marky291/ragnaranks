            ...
            <div id="server-wrapper">
                <section id="curtain">
                    ...
                    <div class="container p-5 my-5">
                        <div class="row">
                            <div class="col-8">
                                <h2 class="font-weight-normal">{{ $listing->name }}</h2>
                            ...
                            <div class="col-4 image" style="background: url('https://steamcdn-a.akamaihd.net/steam/apps/215100/ss_6a9a6e418f37743bee813df7c629976e2965f11e.1920x1080.jpg?t=1524857019')"></div>
                        </div>
                    </div>
                </section>
