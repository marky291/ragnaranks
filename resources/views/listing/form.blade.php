...
@section('content')
	<div class="shadow-inner">
		<div class="container pt-4">
			<listing-profile slug="{{ $slug }}" inline-template>
				<div class="row pb-5 pt-2">
					<div id="sidebar" class="col-4">
						@component('layouts.sidebar')
							<div class="tw-h-full">
								<listing-configurator inline-template>
						...
						<div class="">
							<div :class="'use-accent-'+accent" class="mb-3 server-card item flex-fill shadow border rounded">
								<div id="profile-card" class="profile-block">
									<div class="server-card-head image rounded-top" style="height:350px;" v-bind:style="{ backgroundImage: 'url(' + background + ')' }"></div>
