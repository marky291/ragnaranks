...
<div class="tw-flex tw-flex-col content tw-shadow-md rounded" id="user-actions">
    ...
    @can('analyze', $listing)
        <a class="selector-item {{ request()->segment(3) == 'graphs' ? 'active' : '' }} {{ $listing->accent }}-dark" href="{{ route('listing.graphs.index', $listing) }}">
            <div class="tw-items-center tw-py-3 tw-px-6 tw-flex tw-border-b tw-border-gray-200">
                <div class="tw-pr-4 tw-leading-snug">
                    <h5 class="title tw-mb-1">Graphs Generator</h5>
                    <p class="tw-text-gray-600">We provide useful graphs that can help determine the longevity of the server/listing</p>
                </div>
