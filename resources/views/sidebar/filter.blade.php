    ...
    <filtered-search @filter:changed="changeResource" inline-template>
        <transition name="fade" mode="out-in">
            <div id="filters" class="d-flex tw-shadow flex-column content p-2 rounded tw-mb-6 lg:tw-mb-0">
                <select @change="filterChanged" v-model="rates" style="color: #8795a1" class="mb-2 form-control-sm tw-text-sm tw-rounded-full tw-px-5 tw-py-3 tw-flex tw-items-center tw-cursor-pointer tw-leading-none">
                ...
                <select @change="filterChanged" v-model="mode" style="color: #8795a1" class="mb-2 form-control-sm tw-text-sm tw-rounded-full tw-px-5 tw-py-3 tw-flex tw-items-center tw-cursor-pointer tw-leading-none">
                ...
                <select @change="filterChanged" v-model="tag" style="color: #8795a1" class="mb-2 form-control-sm tw-text-sm tw-rounded-full tw-px-5 tw-py-3 tw-flex tw-items-center tw-cursor-pointer tw-leading-none">
                ...
                <select @change="filterChanged" v-model="sort" style="color: #8795a1" class="mb-2 form-control-sm tw-text-sm tw-rounded-full tw-px-5 tw-py-3 tw-flex tw-items-center tw-cursor-pointer tw-leading-none">
                ...
                <select @change="filterChanged" v-model="paginate" style="color: #8795a1" class="form-control-sm tw-text-sm tw-rounded-full tw-px-5 tw-py-3 tw-flex tw-items-center tw-cursor-pointer tw-leading-none">
