<div class="tw-hidden lg:tw-block">
	...
	<div id="additions" class="content tw-shadow py-0 rounded">
		@foreach (\App\Listings\ListingRepository::LatestEntriesCache(5) as $listing)
            <a href="" style="color:inherit" class="microcard">
			<div style="{{ $loop->last ? null : 'border-bottom: 1px dashed #e3e3e3;' }}">
                    <div class="information d-flex flex-row tw-py-3 tw-items-center hover:tw-bg-black">
