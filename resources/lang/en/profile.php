...
**Please utilize all the configuration options to allow us to maximize the potential of your listing(s)!**',
    ...
    'voting' => [
        ...
        'completed' => 'Thanks for your interest in voting to this server, however you must wait :hours hours from your first vote before you can send another vote',
        ...
        'finished' => 'Your vote has been sent to this server, and will be applied for the next ' . config('ranking.ignore_after_days') . ' days, you can continue to vote every :hours hours, thank you for your continued support on behalf of RagnaRanks and :name.',
    ],
