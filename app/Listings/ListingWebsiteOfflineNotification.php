...
class ListingWebsiteOfflineNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line("We have been monitoring the website belonging to {$this->listing->name} and would like to notify you that it has been offline for {$this->countHours} hours!")
